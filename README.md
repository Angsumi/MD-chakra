...
| **Log2-Expression Boxplot** | [`visualizations/12_Expression_Distribution_Boxplot.png`](file:///home/angsuman/extra_spac/MD%20chakra/visualizations/12_Expression_Distribution_Boxplot.png) | Classic Tukey boxplot showing median, mean, IQR (25th–75th), and whiskers across all samples. |
| **Log2-Expression Violin Plot** | [`visualizations/12b_Expression_Distribution_Violin.png`](file:///home/angsuman/extra_spac/MD%20chakra/visualizations/12b_Expression_Distribution_Violin.png) | Violin kernel density profiles displaying continuous expression distributions per sample. |
